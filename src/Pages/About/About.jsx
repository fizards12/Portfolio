...
import { FaCubes, FaFileCode, FaSearchLocation, FaWhatsapp } from "react-icons/fa";
...
const mystory = {
  description: 'My Name is Mahmoud Sameh. I am Communication and Electronics Engineer and fresh Full-Stack Web Developer. I graduated from Communication and Electronics department, and I finished Reactjs Course that on MaharaTech, the three courses of Web Development track introduced by FWD, and finished Codevolution playlists of React, React Hooks, and React Router.',
  skills: [
    { title: "Degree", text: "Bachelor", icon: FaCubes },
    { title: "Department", text: "Communication And Electronics", icon: ImTarget },
    { title: "Specialization", text: "Software Developer", icon: FaFileCode },
    ...
    <>
      ...
      <Layout.Body className="overflow-hidden container">
        <Section>
          ...
          <Content className={`flex flex-col max-w-screen-lg mx-auto gap-4`}
            {...contentAnimation}
          >
